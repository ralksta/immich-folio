...
## 2024-05-15 - Missing Rate Limiting on Admin Auth
**Vulnerability:** Admin authentication endpoint lacks rate limiting and password length constraints.
**Learning:** Even hidden or obscure endpoints need the same brute-force and resource-exhaustion protections as public endpoints.
**Prevention:** Always implement `checkRateLimit` and input length validation on any endpoint performing authentication.
