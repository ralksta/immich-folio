...
export default function SettingsEditor() {
  ...
  function update(path: string, value: unknown) {
    setSettings((s) => {
      // ⚡ Bolt: Use structuredClone instead of JSON.parse(JSON.stringify)
      // avoids string serialization overhead and handles complex types safely
  ...
  async function handleSave() {
    ...
    // ⚡ Bolt: Use structuredClone instead of JSON.parse(JSON.stringify)
    // avoids string serialization overhead when submitting settings
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
