...
export default function SettingsEditor() {
  ...
  function update(path: string, value: unknown) {
    setSettings((s) => {
      // ⚡ Bolt: structuredClone is native and avoids string serialization overhead compared to JSON.parse(JSON.stringify)
  ...
  async function handleSave() {
    ...
    // ⚡ Bolt: structuredClone avoids string serialization overhead compared to JSON.parse(JSON.stringify)
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
